...
mixin _$CreateAccountEvent {
  ...
  SelectedOptions get selectedOptions => throw _privateConstructorUsedError;
...
class _$_CreateAccount implements _CreateAccount {
  ...
  @override
  String toString() {
    return 'CreateAccountEvent.createAccount(fullName: $fullName, location: $location, email: $email, phoneNumber: $phoneNumber, birthday: $birthday, bio: $bio, gender: $gender, age: $age, profileImage: $profileImage, coverImage: $coverImage, selectedOptions: $selectedOptions, preference: $preference, image1: $image1, image2: $image2, image3: $image3)';
  }
...
abstract class _CreateAccount implements CreateAccountEvent {
  const factory _CreateAccount(
      ...
      required final File coverImage,
      required final SelectedOptions selectedOptions,
      required final String preference,
      final File? image1,
      final File? image2,
      final File? image3}) = _$_CreateAccount;
